...
<div id="superior"> 
	...
	<tr>
		...
		<a href="index2.php" title="Haga clic para ir a la pagina principal">
			<img src="img/logo.png"  style='width:80px;' title="Haga clic aqui para ir al menu principal">
    	</a>
	</td>
	<td style='color:white; text-align=center;' align=center>CENTRAL CAMPESINA HEROES DEL BICENTENARIO<BR>Panel de Administracion</td>
